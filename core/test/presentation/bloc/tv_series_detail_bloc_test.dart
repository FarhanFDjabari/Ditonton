...
import 'package:core/presentation/bloc/tv_series_detail/tv_series_detail_bloc.dart';
  ...
  group("get tv series watchlist", () {
    ...
    blocTest<TvSeriesDetailBloc, TvSeriesDetailState>(
      ...
      build: () {
        ...
        when(mockGetWatchlistTvSeriesStatus.execute(testMovieDetail.id))
            .thenAnswer((_) async => true);
        return tvSeriesDetailBloc;
      },
    ...
    blocTest<TvSeriesDetailBloc, TvSeriesDetailState>(
      ...
      act: (bloc) => bloc.add(AddTvSeriesToWatchlist(testTvSeriesDetail)),
      verify: (bloc) {
        verify(mockGetWatchlistTvSeriesStatus.execute(testMovieDetail.id));
      },
      expect: () => [

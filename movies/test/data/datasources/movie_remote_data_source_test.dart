...
void main() {
  ...
  group('get Now Playing Movies', () {
    final tMovieList =
        MovieResponse.fromJson(json.decode(readJson('now_playing.json')))
            .movieList;
  ...
  group('get Top Rated Movies', () {
    final tMovieList =
        MovieResponse.fromJson(json.decode(readJson('top_rated.json')))
            .movieList;
  ...
  group('get movie recommendations', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async =>
              http.Response(readJson('movie_recommendations.json'), 200));
      // act
  ...
  group('search movies', () {
    ...
    test('should return list of movies when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async =>
              http.Response(readJson('search_spiderman_movie.json'), 200));
      // act
